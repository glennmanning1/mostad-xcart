    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-checkbox">
                <label for="addLogo">
                    <widget class="XLite\View\FormField\Input\Checkbox\Enabled" value="0" fieldName="addLogo" fieldOnly="true" attributes="{_ARRAY_(#class#^#disable-for-same#)}"/>
					...
					<p><strong>To have your logo imprinted in black ink on brochures or newsletters:</strong></p>
					<br />
					<ul>
					...
					<p><br />A one-time logo setup fee of $40 will be added to your total when we process your order.</p>
					</div>
					</div>
                </label>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-checkbox">
                <label for="addLogo">
					...
					<li>Note: Logo display not available on The Reference Section or the Information Station.</li>
					</ul>
					<p><br />A one-time setup fee of $40 will be added to your total when we process your order.</p>
					</div>
					</div>
                </label>
            </div>
