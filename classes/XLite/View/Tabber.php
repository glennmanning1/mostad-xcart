...
class Tabber extends \XLite\View\AView
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            static::PARAM_BODY   => new \XLite\Model\WidgetParam\String('Body template file', '', false),
            static::PARAM_SWITCH => new \XLite\Model\WidgetParam\String('Switch', 'page', false),
            static::PARAM_TAB_PAGES
                => new \XLite\Model\WidgetParam\String('Name of function that returns tab pages', 'getTabPages', false),
        );
    }
