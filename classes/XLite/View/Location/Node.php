...
class Node extends \XLite\View\AView
{
     ...
     * @return integer
     */
    protected function getLocationNodesLimit()
    {
    ...
    {
        return $this->getLocationNodesLimit() < count($this->getParam(self::PARAM_SUBNODES));
    }
    ...
    {
        return array_slice($this->getParam(self::PARAM_SUBNODES), 0, $this->getLocationNodesLimit());
    }
