 ...
 */
class PriceProductVariants extends \XLite\View\Price implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function getNetPrice($value = null)
    {
        return $this->getProductVariant()
            ? $this->getProduct()->calculateQuantityUnitPrice(parent::getNetPrice($value))
