...
namespace XLite\Module\Mostad\QuantityPricing\View\Page\Admin;

/**
 * Quantity pricing page view
 *
...
class QuantityPricing extends \XLite\View\AView
{
    ...
    {
        return array_merge(parent::getAllowedTargets(), array('quantity_pricing'));
    }
