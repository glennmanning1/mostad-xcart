...
/**
 * ParcelItem repository
 *
 */
class ParcelItem extends \XLite\Model\Repo\ARepo
{
    /**
     * Allowable search params
     */
    const SEARCH_LIMIT  = 'limit';
    const P_PARCEL = 'parcel';
     ...
     * @return void
     */
    protected function prepareCndParcel(\Doctrine\ORM\QueryBuilder $queryBuilder, $value)
    {
        if (!empty($value)) {
            $queryBuilder
                ->andWhere('p.pbParcel = :parcel')
                ->setParameter('parcel', $value);
        }
    }
