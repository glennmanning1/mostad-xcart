 ...
 *
 */
class CatalogExtraction extends \XLite\View\AView
{
    /**
     * Register CSS files
     *
    ...
    public function getCSSFiles()
    {
        ...
        $list[] = 'modules/XC/PitneyBowes/export/style.css';
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/XC/PitneyBowes/export/controller.js';
    ...
    {
        return 'modules/XC/PitneyBowes/export/catalog.tpl';
    }
    ...
    {
        $result = 'XLite\Module\XC\PitneyBowes\View\Export\Begin';

        if (!$this->isExportLocked() && $this->isExportNotFinished()) {
            $result = 'XLite\Module\XC\PitneyBowes\View\Export\InProgress';
        }
