...
namespace XLite\Module\CDev\Bestsellers\Core\EventListener;

/**
 * Sales
 */
class Sales extends \XLite\Core\EventListener\Base\Countable
{
    ...
    protected function getItems()
    {
        if (!isset($this->generator)) {
            $this->generator = new \XLite\Module\CDev\Bestsellers\Logic\Sales\Generator(
