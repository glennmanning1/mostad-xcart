...
OUT;
    ...
    protected function prepareRequestDataIntl($data, $packKey)
    {
        ...
        $result = array(
            ...
            'Size' => $config->package_size,  // REGULAR | LARGE
            'Width' => sprintf('%.1f', $width), // Units=inches, decimal, min=0.0, totalDigits=10. Required for LARGE
            'Length' => sprintf('%.1f', $length), // Units=inches, decimal, min=0.0, totalDigits=10. Required for LARGE
            'Height' => sprintf('%.1f', $height), // Units=inches, decimal, min=0.0, totalDigits=10. Required for LARGE
            'Girth' => sprintf('%.1f', $config->girth), // Units=inches, decimal, min=0.0, totalDigits=10. Required for size=LARGE and container=NONRECTANGULAR | VARIABLE/NULL
            'GXG' => $config->gxg,
