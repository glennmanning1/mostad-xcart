...
abstract class AProcessor extends \XLite\Base\SuperClass
{
    ...
    public function getSettingsTemplate()
    {
        ...
        return $module
            ? sprintf('modules/%s/%s/settings.tpl', $module->getAuthor(), $module->getName())
            : '';
    }
    ...
    public function getTestTemplate()
    {
        ...
        return $module
            ? sprintf('modules/%s/%s/test.tpl', $module->getAuthor(), $module->getName())
            : '';
    }
    ...
    public function getRates($inputData, $ignoreCache = false)
    {
        ...
        } elseif ($this->getMethods(static::STATE_ENABLED_ONLY)) {
